	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<!-- Advanced login -->
				<form:form role="form" commandName="forgotPass" action="forgotpassword" method="POST" id="forgot_pass_form">
					<div class="panel panel-body login-form">
						<div class="text-center">
							<div class="icon-object border-slate-300 text-slate-300"><i class="icon-reading"></i></div>
							<h5 class="content-group">Enter your Email below</h5>
						</div>
						...
						<div class="form-group has-feedback has-feedback-left">
							<form:input type="text" class="form-control" name="email" path="email" placeholder="email"></form:input>
